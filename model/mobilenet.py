...
base_model = MobileNet(include_top=True, alpha=1.0, weights=None, input_shape=None, classes = 5)
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(5, activation='softmax')  # Replace 'num_classes' with the actual number of classes
])
...
model.save('E:\\model\\mobilenet.h5', save_format='h5')
